...
Nakagawa, S., Lagisz, M., O’Dea,  R. E., Rutkowska, J., Yang, Y., Noble, D.W.A. & Senior, A. M. 2020. The Orchard Plot: Cultivating the Forest Plot for Use in Ecology, Evolution and Beyond. *Research Synthesis Methods*, (revision) (*EcoEvoRxiv*: https://ecoevorxiv.org/epqa7/)
...
orchard_plot(model_results, mod="Int", xlab = "Standardised mean difference") + 
  annotate(geom="text", x= -0.7, y= 1.5, label= paste0("italic(I)^{2} == ", round(I2[1],4)*100), color="black", parse = TRUE, size = 5) +
...
```{r Figure8, echo = TRUE, eval = TRUE, messages = FALSE, warnings = FALSE, fig.width = 5, fig.height = 3, fig.cap = "Caterpillars plot of the effects of predation on benthic invertebrate communities compared using the log response ratio"}
...
Lim J.N., Senior A.M., Nakagawa S. 2014. Heterogeneity in individual quality and reproductive trade-offs within species. *Evolution*. 68(8):2306-18. http://doi:10.1111/evo.12446
