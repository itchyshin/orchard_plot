...
output:
  ...
  pdf_document:
    toc: yes
subtitle:  "The Orchard Plot: Cultivating Forest Plots for Use in Ecology, Evolution and Beyond"
...
The STAGE 1 survey was designed to answer the following questions:   
 1.	How many papers (percentage from 102 surveyed) present some form of forest plots? (at this stage we could not tell which of these are “classical/original” forest plots, the more detailed questions below with more detailed coding were used to assess this).   
...
Table of papers with potential classical forest plots (to be re-evaluated to se if they are actually can be considered "classical" forest plots):     
...
### 5. What is the frequency of "classical/original" forest plots?    
We re-evaluated the subset of 16 papers with potential "original/classical" forest plots.    
We used the following definition of "classical/original" forest plot:    
...
**Answer 5.**  
Out of 16 papers re-assessed, 12 contained  "original/classical" forest plots (see table below for the references).   
