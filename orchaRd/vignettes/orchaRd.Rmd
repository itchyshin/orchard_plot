...
orchaRd::orchard_plot(english_MR, mod="ManipType", xlab = "Hedges' d")
```
...
```{r echo = TRUE, eval = TRUE, fig.width = 6, fig.height = 4, fig.cap = "Orchard plot of diet qualities impact on standardised mean difference but instead of using the metafor model, using the model results table and changing the transparency of the data"}
orchaRd::orchard_plot(model_results, mod="Int", xlab = "Hedges' d", alpha = 0.2)
```
...
```{r fig.width = 10, fig.height = 4, fig.cap = "Orchard plot of diet qualities impact on log coefficient of variation"}
...
orchard_plot(senior_MR, mod = "ManipType", xlab = "log Coefficient of Variation (ln CVR)", alpha = 0.8)
...
```{r echo = TRUE, eval = TRUE, fig.width = 6.597222, fig.height = 9, fig.cap = "Orchard plot of the the strength of correlation between maternal and offspring size within-species"}
	orchard_plot(lim_MR, mod = "Phylum", xlab = "Zr", alpha = 0.60) + 
